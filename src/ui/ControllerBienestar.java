...
public class ControllerBienestar implements Initializable {
	...
	public void tellme() {
        ...
        public void addConcentracion(ActionEvent event){
            ...
            if (horas.getText().equalsIgnoreCase("") || horas.getText().equalsIgnoreCase(" ") || horas.getText().equalsIgnoreCase(null)
                    && minutos.getText().equalsIgnoreCase("") || minutos.getText().equalsIgnoreCase(" ") || minutos.getText().equalsIgnoreCase(null)
                    && motivo.getText().equalsIgnoreCase("") || motivo.getText().equalsIgnoreCase(" ") || motivo.getText().equalsIgnoreCase(null)) {
                ...
                if (sl1.getValue() == 0.0) {
                    ...
                    if (alert.getResult().getButtonData().compareTo(ButtonBar.ButtonData.OK_DONE) ==0) {
                        ...
                        if (tt.getR().getHour()==0&&tt.getR().getMinute()==0) {
                            ...
                            alert.setHeaderText(null);
                            alert.setTitle("Error");
                            alert.setContentText("No se puede registrar una Concentracion de menos de un 1 minuto. Se ha contado: " + tt.getR().getHour()+"Horas, "+tt.getR().getMinute()+"Minutos, "+tt.getR().getSecond()+"Segundos.");
                            alert.showAndWait();
                        }else{
